...
#include <memory>
#include "../CameraTest/capturewindow.h"
...
QT_MOC_LITERAL(1, 14, 8), // "setFrame"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6) // "pixmap"

    },
    "CaptureWindow\0setFrame\0\0pixmap"
};
...
void CaptureWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setFrame((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
    }
}
