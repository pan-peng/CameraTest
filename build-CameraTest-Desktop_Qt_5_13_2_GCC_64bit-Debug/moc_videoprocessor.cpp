...
#include <memory>
#include "../CameraTest/videoprocessor.h"
...
QT_MOC_LITERAL(1, 15, 6), // "dispay"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 6), // "pixmap"
QT_MOC_LITERAL(4, 30, 10), // "startVideo"
QT_MOC_LITERAL(5, 41, 9) // "stopVideo"

    },
    "VideoProcessor\0dispay\0\0pixmap\0startVideo\0"
    "stopVideo"
};
...
void VideoProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dispay((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoProcessor::dispay)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoProcessor::dispay(QPixmap _t1)
{
